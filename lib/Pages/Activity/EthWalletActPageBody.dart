...
class EthWalletActPageBody extends StatelessWidget {
  const EthWalletActPageBody ({Key? key}) : super(key: key);
          ...
          children: [
            ...
            Card(
              child: ListTile(
                ...
                trailing: Text("ETH -1276,76", style: TextStyle(color: Colors.red),),
              ),
            ),
        Card(
          child: ListTile(
            ...
            trailing: Text("ETH -10180,30", style: TextStyle(color: Colors.red),),
          ),
        ),
        Card(
          child: ListTile(
            ...
            trailing: Text("ETH 9109,21", style: TextStyle(color: Colors.green),),
          ),
        ),
        Card(
          child: ListTile(
            ...
            trailing: Text("ETH 11512,88", style: TextStyle(color: Colors.green),),
          ),
        ),
        Card(
          child: ListTile(
            ...
            trailing: Text("ETH -4878,44", style: TextStyle(color: Colors.red),),
          ),
        ),
