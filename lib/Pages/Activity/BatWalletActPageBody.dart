...
class BatWalletActPageBody extends StatelessWidget {
  const BatWalletActPageBody ({Key? key}) : super(key: key);
      ...
      children: [
        ...
        Card(
          child: ListTile(
            ...
            trailing: Text("BAT -1276,76", style: TextStyle(color: Colors.red),),
          ),
        ),
        Card(
          child: ListTile(
            ...
            trailing: Text("BAT -10180,30", style: TextStyle(color: Colors.red),),
          ),
        ),
        Card(
          child: ListTile(
            ...
            trailing: Text("BAT 9109,21", style: TextStyle(color: Colors.green),),
          ),
        ),
        Card(
          child: ListTile(
            ...
            trailing: Text("BAT 11512,88", style: TextStyle(color: Colors.green),),
          ),
        ),
        Card(
          child: ListTile(
            ...
            trailing: Text("BAT -4878,44", style: TextStyle(color: Colors.red),),
          ),
        ),
